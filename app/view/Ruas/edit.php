...
<head>
    ...
    <title>Edit Data Master Ruas</title>
            ...
            <div class="panel-body">
                <section class="section">
                    <div class="section-header">
                        <h4 class="panel-title fw-bold font-timesnew">Edit Data Master Ruas</h4>
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb breadcrumb-item">
                                <a href="edit.php?id=<?=$id?>" class="text-decoration-none text-primary">Edit Data Ruas</a></div>
                        </div>
                    </div>
                </section>
                <div class="row">
                            ...
                            <div class="table-responsive">
                                <form action="act-edit.php" method="post">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <td>Kode Ruas </td>
                                            <td><input type="text" name="kode_ruas" value="<?=$row['kode_ruas']?>" class="form-control">
                                            <small class="text-muted">Masukkan kode Ruas</small>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Nama Ruas </td>
                                            <td><input type="text" name="nama_ruas" value="<?=$row['nama_ruas']?>" class="form-control">
                                            <small class="text-muted">Masukkan Nama Ruas</small>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Panjang Ruas </td>
                                            <td><input type="number" name="panjang_ruas" value="<?=$row['panjang_ruas']?>" class="form-control">
                                            <small class="text-muted">Masukkan Panjang Ruas</small>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Lokasi Ruas </td>
                                            <td><input type="text" name="lokasi_ruas" value="<?=$row['lokasi_ruas']?>" class="form-control">
                                            <small class="text-muted">Masukkan Lokasi Ruas</small>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Jumlah Gerbang Tol</td>
                                            <td><input type="number" name="jumlah_ruas" value="<?=$row['jumlah_ruas']?>" class="form-control">
